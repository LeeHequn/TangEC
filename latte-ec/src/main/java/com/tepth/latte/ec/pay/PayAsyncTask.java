...
public class PayAsyncTask extends AsyncTask<String, Void, String> {
    ...
    PayAsyncTask(Activity activity, IAlPayResultListener listener) {
    ...
    protected String doInBackground(String... strings) {
        final String alSign = strings[0];
        final PayTask payTask = new PayTask(ACTIVITY);
        return payTask.pay(alSign, true);
    }
    ...
    protected void onPostExecute(String result) {
        ...
        //支付宝返回此次支付结果及加签，建议对支付宝签名信息用签约时支付宝提供的公钥进行验签
